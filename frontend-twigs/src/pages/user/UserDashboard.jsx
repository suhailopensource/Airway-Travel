      ...
      <div className="stats-grid" style={{ marginBottom: '2.5rem' }}>
        ...
        {dashboard.upcomingFlights && dashboard.upcomingFlights.length > 0 && (
          <div className="stat-card success">
            ...
            <div className="stat-value">{dashboard.upcomingFlights.length}</div>
          </div>
        )}
        {dashboard.pastFlights && dashboard.pastFlights.length > 0 && (
          <div className="stat-card info">
            <div className="stat-label">Past Flights</div>
            <div className="stat-value">{dashboard.pastFlights.length}</div>
          </div>
        )}
      </div>
      ...
      {dashboard.upcomingFlights && dashboard.upcomingFlights.length > 0 && (
        <Box css={{ marginBottom: '3rem' }}>
          ...
          <div className="flight-list">
            {dashboard.upcomingFlights.map((flight) => (
